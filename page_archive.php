...
add_action( 'genesis_entry_content', 'bit51_page_archive_content' );
add_action( 'genesis_post_content', 'bit51_page_archive_content' );
/**
 ...
 * @since 1.6
 */
function bit51_page_archive_content() { ?>
